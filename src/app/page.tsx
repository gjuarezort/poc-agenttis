            ...
            {loading ? (
              ...
              <div className="grid-cols-2" style={{ gap: "1.25rem" }}>
                ...
                <div className="glass-panel" style={{ padding: "1.25rem" }}>
                  ...
                  <div style={{ marginTop: "1rem", padding: "0.6rem 1rem", background: "var(--bg-surface-solid)", border: "1px solid var(--border-color)", borderRadius: "var(--radius-md)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem" }}>
                    ...
                    <button className="btn btn-primary" onClick={() => setActiveTab("playground")} style={{ padding: "0.4rem 0.9rem", fontSize: "0.8rem", flexShrink: 0 }}>
                      {language === "es" ? "Consultar" : "Query"} <ArrowRight size={13} />
                    </button>
                  </div>
                </div>
              </div>
